...
public class Register {
	...
	public String toString() {
		return "Register [regid=" + regid + ", fname=" + fname + ", lname=" + lname + ", email=" + email + ", pass="
				+ pass + ", mobile=" + mobile + ", address=" + address + ", hashCode()=" + hashCode() + ", getRegid()="
				+ getRegid() + ", getFname()=" + getFname() + ", getLname()=" + getLname() + ", getEmail()="
				+ getEmail() + ", getPass()=" + getPass() + ", getMobile()=" + getMobile() + ", getAddress()="
				+ getAddress() + ", getClass()=" + getClass() + ", toString()=" + super.toString() + "]";
	}
	@Override
	public int hashCode() {
